...
import { User, Mail, Lock, Eye, EyeOff, Users, Car, Zap, Bike, CheckCircle2 } from 'lucide-react'
      ...
      >
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4">
          <p className="text-xs text-blue-700">
            Click the link in your email to activate your account and start using Shield Parking.
          </p>
        </div>
      </motion.div>
    )
